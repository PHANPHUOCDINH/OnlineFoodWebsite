...
{
    public class NHANVIENsontroller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MANV,TENTK,HOTEN,NGAYSINH,GIOITINH,SDT")] NHANVIEN nHANVIEN)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MANV,TENTK,HOTEN,NGAYSINH,GIOITINH,SDT")] NHANVIEN nHANVIEN)
        {
            if (ModelState.IsValid)
            {
